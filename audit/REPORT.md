...
All deployed addresses are sourced from the canonical [`DeployedAddresses.sol`](src/DeployedAddresses.sol) library.

| Contract                            | Address (Mainnet)                            | Address (Holesky Testnet)                    |
| ----------------------------------- | -------------------------------------------- | -------------------------------------------- |
| StakingContract (impl)              | `0x0A7272e8573aea8359FEC143ac02AED90F822bD0` | `0xcd01846F1b37aCE16916969989C136e3c52ef7d2` |
| StakingContract (proxy)             | `0x1e68238cE926DEC62b3FBC99AB06eB1D85CE0270` | `0xe8Ff2a04837aac535199eEcB5ecE52b2735b3543` |
| ConsensusLayerFeeDispatcher (impl)  | `0x462Dd07A79e5DDfBe0C171449C5c01788d5d03C3` | `0xD36B422a7EE65219732724d849B8b6BceD6155Fe` |
| ConsensusLayerFeeDispatcher (proxy) | `0xE8EC6F702D68ded71112031D78bBFf959c7234C7` | `0x50Dba42662FD69f5Fd9236540aaD9f99f7F6b3b2` |
| ExecutionLayerFeeDispatcher (impl)  | `0xca4DD914fA713214844c84F153A5e1627536a7fC` | `0xa69dDEBd0B6893A6F3d34A5df610d0E2ED433D18` |
| ExecutionLayerFeeDispatcher (proxy) | `0x72b4C52f18f52EbA3E4290a002dF7c387427b058` | `0x639d818639B85a1892Bfbb40Bd724b4Ddea43C0C` |
| FeeRecipient (impl)                 | `0x933fBfeb4Ed1F111D12A39c2aB48657e6fc875C6` | `0x1AcD717aDF8A3A1e4c23C6510cfbE76834E3f1bf` |
